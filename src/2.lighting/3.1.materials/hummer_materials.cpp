...
int main() {
	...
	HummerShader _cubeShader("3_1_hummer_materials.vs", 
		"3_1_hummer_materials.fs");
	...
	while (!glfwWindowShouldClose(_window))
	{
		...
		glm::vec3 _ambientColor = _lightColor * glm::vec3(0.3f);
		glm::vec3 _diffuseColor = _lightColor * glm::vec3(0.7f); 
		...
		_cubeShader.setVec3("material.ambient",  1.0f, 0.5f, 0.31f);
		_cubeShader.setVec3("material.diffuse",  1.0f, 0.5f, 0.31f);
		_cubeShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f);
		_cubeShader.setFloat("material.shinness", 512);
