...
// camera
Camera _myCamera(glm::vec3(-5.0f, 0.0f, 10.0f));
...
// light
glm::vec3 _lightPos(1.2f, 4.0f, 2.0f);
...
int main() {
	...
	// -------------------------------------
	HummerShader _lightingShader("hummer_lightCube_2_1.vs", "hummer_lightCube_2_1.fs");
	HummerShader _cubeShader("hummer_cube_2_1.vs", "hummer_cube_2_1.fs");
	...
	while (!glfwWindowShouldClose(_window))
	{
		...
		// ----------------
		_cubeShader.use();
		_cubeShader.setVec3("objectColor", 0.2f, 0.2f, 0.9f);
		_cubeShader.setVec3("lightColor", 1.0f, 0.5f, 0.31f);

		// projection, view, world transformations
		...
		//_model = glm::translate(_model, glm::vec3(0.f, 0.f, -5.f));
		_model = glm::rotate(_model, glm::radians(45.f), glm::vec3(1.0f, 0.3f, 0.5f));
		...
		// -----------------------------
		_lightingShader.use();
		_lightingShader.setVec3("lightColor", 1.0f, 0.5f, 0.31f);
		_lightingShader.setMat4("projection", _projection);
		_lightingShader.setMat4("view", _view);
		_model = glm::mat4(1.0f);
		_model = glm::translate(_model, _lightPos);
		_model = glm::scale(_model, glm::vec3(0.1f)); 
		_lightingShader.setMat4("model", _model);
