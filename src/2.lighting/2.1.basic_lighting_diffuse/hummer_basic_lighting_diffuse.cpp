...
int main() {
	...
	HummerShader _cubeShader("2_1_hummer_basic_lighting.vs", "2_1_hummer_basic_lighting.fs");
	...
	while (!glfwWindowShouldClose(_window))
	{
		...
		// ----------------
		_cubeShader.use();
		_cubeShader.setVec3("objectColor", _cubeColor);
		...
		//_model = glm::rotate(_model, glm::radians(45.f), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		// -----------------------------
		_lightingShader.use();
		_lightingShader.setVec3("lightColor", _lightColor);
