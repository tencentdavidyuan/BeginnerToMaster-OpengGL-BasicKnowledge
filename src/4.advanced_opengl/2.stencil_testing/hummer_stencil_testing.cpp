...
int main() {
	...
	float planeVertices[] = {
		// positions          // texture Coords (note we set these higher than 1 (together with GL_REPEAT as texture wrapping mode). this will cause the floor texture to repeat)
		 5.0f, 0.f,  5.0f,  2.0f, 0.0f,
		-5.0f, 0.f,  5.0f,  0.0f, 0.0f,
		-5.0f, 0.f, -5.0f,  0.0f, 2.0f,
			   
		 5.0f, 0.f,  5.0f,  2.0f, 0.0f,
		-5.0f, 0.f, -5.0f,  0.0f, 2.0f,
		 5.0f, 0.f, -5.0f,  2.0f, 2.0f
	};
	...
	while (!glfwWindowShouldClose(_window))
	{
		...
		_model = glm::translate(_model, glm::vec3(0.0f, -0.51f, 0.0f));
		...
		// ------------------------------------
		{
			...
			shaderSingleColor.setMat4("projection", _projection);
			shaderSingleColor.setMat4("view", _view);
			...
			for (int i = 0; i < 10; ++i)
			{
				...
				shaderSingleColor.setMat4("model", _model);
